    ...
    .then((posts) => {
        ...
        for (let i = 0; i < paginatedPosts.length; i++) {
          ...
          document
            ...
            .addEventListener("click", (event) =>
              profile(event.target.innerHTML)
            );
            ...
            .then((data) => {
              ...
              if (post.creator === data.user_requesting) {
                ...
                edit_btn.addEventListener("click", () =>
                  edit_post(post.id, post.post, post_element)
                );
              }
            });
        }
      ...
      `;
        ...
        document
          ...
          .addEventListener("submit", () => edit(post_id));
      }
    });
}
